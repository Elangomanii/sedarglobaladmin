	...
	<div id="content" class="content">
		...
		<div class="panel-body" id="form_validation">
		    <p>
                        <a class="btn btn-primary btn-sm " href="<?php echo site_url('GlobalController/FranchisingOpportunities_Add')?>"><i class="fa fa-plus fa-1x"></i> <span class="f-s-14 f-w-500">Add </span></a>
                    </p>
			...
			<tbody>
				...
				<a href="<?php echo site_url('GlobalController/FranchisingOpportunities_Edit/'.$row['id'])?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i> </a>
				  ...
				  <a href="<?php echo site_url('GlobalController/FranchisingOpportunities_Delete/'.$row['id'])?>" class="btn btn-xs btn-danger" id="delete_box"><i class="fa  fa-trash-o"></i> </a>
